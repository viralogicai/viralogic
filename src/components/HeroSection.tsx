...
export const HeroSection = () => {
    ...
    return (
        <section className="relative pt-32 pb-32 overflow-hidden px-6">
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-brand-cyan/20 blur-[120px] rounded-full -z-10" />
            ...
            <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
                        Bật chế độ viral <br />
                        <span className="text-gradient-brand">Prompt Kit tối ưu traffic</span>
                    </h1>
                    ...
                    <div className="lg:hidden relative w-[280px] h-[280px] mx-auto mb-10">
                        ...
                        <div className="relative w-full h-full animate-float-medium">
                            <img
                            ...
                            />
                            {/* Mobile Badge */}
                            <div className="absolute -right-2 top-10 bg-black/80 backdrop-blur-md border border-brand-cyan/50 px-3 py-2 rounded-lg shadow-lg border-l-2 border-l-brand-cyan">
                                <div className="text-[10px] text-gray-400 uppercase tracking-widest">Prompts</div>
                                <div className="text-lg font-bold font-display text-white">1000+</div>
                            </div>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-4 mb-10">
                        <Button variant="cyber" size="lg" className="group" onClick={scrollToPricing}>
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-8 py-4 rounded-full border border-white/10 hover:bg-white/5 transition-all text-gray-300 hover:text-white font-medium"
                        >
