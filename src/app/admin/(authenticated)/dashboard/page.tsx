        ...
        <>
            ...
            <div className="glass-panel p-6 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Link href="/admin/prompts" className="p-4 bg-white/5 hover:bg-white/10 rounded-lg transition-colors block">
                    ...
                    <Link href="/admin/resources" className="p-4 bg-white/5 hover:bg-white/10 rounded-lg transition-colors block">
